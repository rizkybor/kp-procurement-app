        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="md:col-span-1 flex justify-between">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Buat Vendor Baru</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Tambahkan vendor baru dengan rincian perusahaan, PIC, dan dokumen pendukung.
                    </p>
                </div>
            </div>
                    ...
                    <div class="px-4 py-5 sm:p-6 bg-white dark:bg-gray-800 shadow rounded-lg">
                        <div class="grid grid-cols-1 gap-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-input id="name" name="name" type="text" class="mt-1 block w-full"
                                             value="{{ old('name') }}" required placeholder="Nama Vendor"/>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-input id="bank_name" name="bank_name" type="text" class="mt-1 block w-full"
                                             value="{{ old('bank_name') }}" placeholder="Nama Bank"/>
                                ...
                                <div>
                                    ...
                                    <x-input id="bank_number" name="bank_number" type="text" class="mt-1 block w-full"
                                             value="{{ old('bank_number') }}" placeholder="Nomor Rekening"/>
                            ...
                            <div class="pt-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <x-label for="file_deed_of_company">Akta Perusahaan (PDF/JPG/PNG, max 5MB)</x-label>
                                        <input id="file_deed_of_company" name="file_deed_of_company" type="file"
                                               class="mt-1 block w-full">
                                        <x-input-error for="file_deed_of_company" class="mt-2"/>
                                    </div>
                                    <div>
                                        <x-label for="file_legalization_letter">SK Pengesahan</x-label>
                                    ...
                                    <div>
                                        <x-label for="file_integrity_pact">Pakta Integritas</x-label>
                                        <input id="file_integrity_pact" name="file_integrity_pact" type="file"
                                               class="mt-1 block w-full">
                                        <x-input-error for="file_integrity_pact" class="mt-2"/>
                                    </div>
                                    <div>
                                        <x-label for="file_vendor_feasibility">Uji Kelayakan Vendor</x-label>
                                    ...
                                    <div class="sm:col-span-2">
                                        <x-label for="file_interest_statement">Surat Pernyataan Minat</x-label>
                        ...
                        <div class="flex items-center justify-between mt-6">
                            ...
                            <x-button>Simpan Data Vendor</x-button>
                        </div>
                    </div>
                </form>
