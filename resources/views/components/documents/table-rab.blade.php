...
<div x-data="rabInline({
    ...
    <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 class="font-semibold dark:text-gray-100">Edit Daftar RAB</h2>
    </header>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center">
                                        <input type="number" step="1" min="0"
                                            ...
                                            x-model.number="qty" @input="$dispatch('rab-row-change', { id, total })"
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center">
                                        <input type="number" step="1" min="0"
                                            ...
                                            x-model.number="harga" @input="$dispatch('rab-row-change', { id, total })"
                                            @change="$dispatch('rab-save-row', { id, qty, harga })" />
