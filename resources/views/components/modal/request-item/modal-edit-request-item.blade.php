    ...
    <div class="fixed inset-0 bg-gray-900 bg-opacity-30 z-50 flex items-center justify-center" x-show="modalOpen" x-cloak>
        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-lg w-full"
            ...
            <div class="flex justify-center items-center">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 text-center">Edit Permintaan
                    Barang</h3>
            </div>
            <form
                action="{{ route('work_request.work_request_items.update', ['id' => $workRequest->id, 'work_request_item_id' => $itemRequest->id]) }}"
                method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-2 gap-4 text-left">
                    ...
                    <div>
                        ...
                        <x-input id="item_desc_request" type="text" name="item_desc_request"
                            ...
                            placeholder="Masukkan deskripsi" value="{{ $itemRequest->item_desc_request }}" />
                    ...
                    <div>
                        ...
                        <x-input id="notes" type="text" name="notes" class="mt-1 block w-full min-h-[40px]"
                            required autocomplete="notes" placeholder="Masukkan keterangan"
                            value="{{ $itemRequest->notes }}" />
                    ...
                    <div>
                        ...
                        <x-input id="quantity" type="number" name="quantity" class="mt-1 block w-full min-h-[40px]"
                            required autocomplete="quantity" placeholder="Masukkan jumlah"
                    ...
                    <div>
                        ...
                        <x-input id="unit" type="text" name="unit" class="mt-1 block w-full min-h-[40px]"
                            required autocomplete="unit" placeholder="Masukkan satuan"
                            value="{{ $itemRequest->unit }}" />
