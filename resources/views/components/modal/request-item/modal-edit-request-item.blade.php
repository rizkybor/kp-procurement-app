                ...
                <div class="grid grid-cols-2 gap-4 text-left">
                    ...
                    <div>
                        ...
                        <x-input id="item_name" type="text" name="item_name" class="mt-1 block w-full min-h-[40px]"
                            required autocomplete="item_name" placeholder="Masukkan deskripsi"
                            value="{{ $itemRequest->item_name }}" />
                    ...
                    <div>
                        ...
                        <x-input id="description" type="text" name="description"
                            ...
                            placeholder="Masukkan keterangan" value="{{ $itemRequest->description }}" />
