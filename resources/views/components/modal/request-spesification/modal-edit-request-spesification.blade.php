    ...
    <div class="fixed inset-0 bg-gray-900 bg-opacity-30 z-50 flex items-center justify-center" x-show="modalOpen" x-cloak>
        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-lg w-full"
            ...
            <div class="flex justify-center items-center">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Edit Spesification</h3>
            </div>
            <form
                action="{{ route('work_request.work_spesifications.update', ['id' => $workRequest->id, 'work_spesification_id' => $specRequest->id]) }}"
                method="POST">
                @csrf
                @method('PUT')
                {{-- @method('PUT') --}}
                <div class="grid gap-4 text-left">
                    ...
                    <div>
                        ...
                        <x-input id="scope_of_work" type="text" name="scope_of_work"
                            ...
                            placeholder="Masukkan lingkup pekerjaan" value="{{ $specRequest->scope_of_work }}" />
                    ...
                    <div>
                        ...
                        <x-input id="contract_type" type="text" name="contract_type"
                            ...
                            placeholder="Masukkan tipe kontrak" value="{{ $specRequest->contract_type }}" />
                    ...
                    <div>
                        ...
                        <x-input id="safety_aspect" type="text" name="safety_aspect"
                            ...
                            placeholder="Masukkan aspek keamanan" value="{{ $specRequest->safety_aspect }}" />
                    ...
                    <div>
                        ...
                        <x-input id="reporting" type="text" name="reporting" class="mt-1 block w-full min-h-[40px]"
                            required autocomplete="reporting" placeholder="Masukkan laporan"
                            value="{{ $specRequest->reporting }}" />
                    ...
                    <div>
                        ...
                        <x-input id="provider_requirements" type="text" name="provider_requirements"
                            ...
                            placeholder="Masukkan kebutuhan penyedia"
                            value="{{ $specRequest->provider_requirements }}" />
                    ...
                    <div>
                        ...
                        <x-input id="payment_procedures" type="text" name="payment_procedures"
                            ...
                            placeholder="Masukkan mekanisme pembayaran"
                            value="{{ $specRequest->payment_procedures }}" />
