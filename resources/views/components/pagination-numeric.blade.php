<div class="flex justify-center">
    <nav class="flex" role="navigation" aria-label="Navigation">
        ...
        <ul class="inline-flex text-sm font-medium -space-x-px rounded-lg shadow-sm">
            <li>
                <span class="inline-flex items-center justify-center rounded-l-lg leading-5 px-3.5 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 text-teal-500">1</span>
            </li>
            <li>
        ...
        <div class="ml-2">
            <a href="#0" class="inline-flex items-center justify-center rounded-lg leading-5 px-2.5 py-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 border border-gray-200 dark:border-gray-700/60 text-teal-500 shadow-sm">
